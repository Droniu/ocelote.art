...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  galleries = {
    ...
    getGalleries: (
      ...
      this.request<GalleryListResponse, Error>({
        path: `/galleries`,
        method: "GET",
        query: query,
        secure: true,
     ...
     * @tags Gallery
     * @name PostGalleries
     * @request POST:/galleries
     * @secure
     */
    postGalleries: (data: GalleryRequest, params: RequestParams = {}) =>
      this.request<GalleryResponse, Error>({
        path: `/galleries`,
        method: "POST",
        body: data,
        secure: true,
     ...
     * @secure
     */
    getGalleriesId: (id: number, params: RequestParams = {}) =>
      this.request<GalleryResponse, Error>({
        path: `/galleries/${id}`,
        method: "GET",
        secure: true,
     ...
     * @tags Gallery
     * @name PutGalleriesId
     * @request PUT:/galleries/{id}
     * @secure
     */
    putGalleriesId: (id: number, data: GalleryRequest, params: RequestParams = {}) =>
      this.request<GalleryResponse, Error>({
        path: `/galleries/${id}`,
        method: "PUT",
        body: data,
     ...
     *
     * @tags Gallery
     * @name DeleteGalleriesId
     * @request DELETE:/galleries/{id}
     * @secure
     */
    deleteGalleriesId: (id: number, params: RequestParams = {}) =>
