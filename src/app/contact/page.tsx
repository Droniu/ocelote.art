...
export default function Contact() {
  return (
    <div className="grid grid-cols-1 w-screen h-full">
      <div className="flex flex-col justify-center items-center lg:gap-16 gap-8 text-white">
        ...
        <div className="flex lg:flex-row flex-col lg:gap-8 gap-4 items-center whitespace-nowrap mb-16 h-auto">
          <InstagramButton />
          <WhatsappButton />
          <MailButton />
        </div>
